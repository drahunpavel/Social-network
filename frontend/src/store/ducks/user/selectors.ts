...
export const selectUserIsLoaded = (state: RootState): boolean => selectUserState(state).status === LoadingStatus.LOADED; //статус LOADED говорит о том, что есть ответ от сервевра
